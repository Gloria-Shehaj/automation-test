...
public class FiltersPage {
  ...
  //    assertEquals(6, notebooksPage.getSizeOfProductsDisplayed());
	...
	//By bluecolor = By.xpath("//a[2]/div[@safeclass~'\\bcolor\\b.*\\bswatch-option\\b']");
	...
	public void hoverJacketsMenu() {
		...
		//hover.moveToElement(womenMenu).moveToElement(topsMenu).moveToElement(jacketsMenu).clickAndHold().build().perform();
	}
